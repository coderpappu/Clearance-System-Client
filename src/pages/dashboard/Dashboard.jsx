  ...
  return (
    <div className="">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-4 dark:bg-dark-card rounded-lg bg-white intro_card px-5 py-8 ">
          ...
          <p className="text-gray-600 dark:text-gray-600">
            Manage your campus clearance system efficiently. Track student
            clearances, monitor due payments, and oversee department activities
            all in one place.
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        <ClearanceStatusChart dashboardData={dashboardStats?.data} />
        <BarChartComponent dashboardData={dashboardStats?.data} />
        <AreaChartComponent dashboardData={dashboardStats?.data} />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <LastLogin dashboardData={dashboardStats?.data} />
        <AccordionComponent />
      </div>
    </div>
  );
